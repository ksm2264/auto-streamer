...
- Tools -> Websocket Server Settings (4x compat one) -> Set port to 4444, password to 123 (this allows the python program to communicate with OBS) -> Check Enable Websocket Server
